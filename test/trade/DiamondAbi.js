export const abi = [
    ...
    },
    {
        inputs: [
            {
                internalType: "address",
                name: "_termsAndConditionsAddress",
                type: "address",
            },
        ],
